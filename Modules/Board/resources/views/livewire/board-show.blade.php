<x-main.index>
  ...
  <x-main.container>
    <div class="flex items-center justify-between">
      <h5 class="hidden text-xl font-bold lg:block">掲示板</h5>
      <a class="flex items-center px-5 text-sm text-[#3289FA] hover:opacity-40 lg:px-0" href="{{ route('draft.index') }}">
    ...
    @if ($posts->isEmpty())
      <div class="mt-[30px] flex h-[calc(var(--vh)*100-190px)] flex-col items-center justify-center rounded-xl border">
        ...
        <div class="mt-5 text-[1.25rem] font-bold text-[#222222] text-opacity-10">掲示物がありません</div>
      </div>
    @else
      <div class="mt-[30px] hidden grid-cols-[66%,10%,8%,14%,2%] lg:grid">
