  ...
  <x-main.container>
    ...
    <form class="p-5 lg:mt-[30px] lg:p-0" id="postForm" wire:submit.prevent="submitPost" enctype="multipart/form-data">
      ...
      <div class="mt-10 hidden justify-center space-x-5 lg:flex">
        <a class="inline-flex h-[50px] w-[230px] whitespace-nowrap items-center justify-center rounded-md outline outline-1 outline-[#5E5E5E] bg-white font-bold uppercase tracking-widest text-[#5E5E5E] hover:opacity-40"
        ...
        <button
          class="inline-flex h-[50px] w-[230px] whitespace-nowrap items-center justify-center rounded-md bg-[#3289FA] font-bold uppercase tracking-widest text-white hover:bg-blue-100"
