<x-modal name="open-schedule-create-modal">
  <form class="p-4" method="post" action="{{ route('calendar.store') }}">
    ...
    <div class="mt-4">
      ...
      <x-text-input class="js-datepicker mt-1 block w-full" id="start_date" name="start_date" type="text" required />
    ...
    <div class="mt-2">
      ...
      <x-text-input class="js-datepicker mt-1 block w-full" id="end_date" name="end_date" type="text" required />
