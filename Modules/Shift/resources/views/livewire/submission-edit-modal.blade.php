  ...
  @if ($schedule->shiftStatus || !$manager->OverSubmissionPeriod)
    <div class="px-4 pb-4">
      ...
      <div class="mt-4">
        ...
        <x-text-input class="mt-1 block w-full" id="start_time" name="start_time" type="time" readonly
      ...
      <div class="mt-2">
        ...
        <x-text-input class="mt-1 block w-full" id="end_time" name="end_time" type="time" readonly
