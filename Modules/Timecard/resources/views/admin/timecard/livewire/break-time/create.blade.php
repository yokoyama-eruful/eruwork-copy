<div class="flex flex-col items-center">
  <button class="flex items-center justify-center space-x-[4.5px] hover:opacity-40" type="button"
    x-on:click="$dispatch('open-modal','create-break-time-modal-{{ $user->id }}')">
    <div class="mt-[1px]" x-on:click="$dispatch('open-modal','create-break-time-modal-{{ $user->id }}')">
  ...
  <x-modal name="create-break-time-modal-{{ $user->id }}" :title="'休憩時間作成'">
    <form wire:submit="storeBreakTime">
