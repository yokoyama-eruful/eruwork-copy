     ...
     <form wire:submit="updateWorkTime">
       ...
       <div class="mt-5">
         ...
         <div class="relative mt-1">
           <x-text-input
             class="js-datepicker block w-full appearance-none rounded border border-gray-300 py-1 pl-3 pr-8"
       ...
       <div class="mt-5">
         ...
         <x-text-input class="mt-1 block w-full" name="out-time" type="time" wire:model="form.out_time"
           required />
       </div>
