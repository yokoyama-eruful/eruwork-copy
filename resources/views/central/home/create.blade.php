...
@section('body')
  <div class="flex h-full w-5/6 flex-col">
    <main class="flex-1 p-10">
      ...
      <form class="m-5 flex flex-col space-y-5" action="{{ route('central.store') }}" method="POST">
        @csrf
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              id="facility-icon" name="name" type="text" value="{{ old('name') }}" placeholder="えるふる">
          </div>
          @error('name')
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              id="phone-icon" name="phone_number" type="text" value="{{ old('phone_number') }}"
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              id="facility-icon" name="email" type="text" value="{{ old('email') }}"
        ...
        <button class="mx-auto rounded bg-blue-500 px-4 py-2 hover:bg-blue-600" type="submit">作成</button>
      </form>
    </main>
  </div>
@endsection
