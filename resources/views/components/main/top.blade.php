<div class="flex min-h-[30px] w-full items-center justify-between pt-[30px] sm:max-h-[30px] sm:min-w-[1300px] sm:pt-0"
  ...
  {{-- <x-modal name="profile" title="プロフィール設定" maxWidth="440">
    <form class="px-[30px] py-5">
      <div class="grid grid-cols-[30%,70%] items-center">
        <button
          class="flex h-[70px] w-[70px] items-center justify-center rounded-full bg-[#000000] bg-opacity-30 hover:opacity-50"
          type="button">
          @if (Auth::user()->iconImage)
            <img class="h-full w-full" src="{{ Auth::user()->IconImage }}">
          @else
      ...
      <div class="relative mt-[10px] grid grid-cols-[30%,70%] items-center">
        ...
        <div class="relative w-full">
          <x-text-input class="pr-10" id="new_password" name="new_password" type="password"
          ...
          <button class="absolute right-3 top-1/2 -translate-y-1/2" id="new_togglePassword" type="button">
            ...
            <svg class="hidden" id="new_icon-show" width="18" height="18" viewBox="0 0 18 18"
      ...
      <div class="relative mt-[10px] grid grid-cols-[30%,70%] items-center">
        ...
        <div class="relative w-full">
          <x-text-input class="pr-10" id="new_password_confirmation" name="new_password_confirmation"
