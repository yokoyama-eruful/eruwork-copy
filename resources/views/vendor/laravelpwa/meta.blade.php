...
<link href="{{ route('laravelpwa.manifest') }}" rel="manifest">
...
<link href="{{ data_get(end($config['icons']), 'src') }}" rel="icon"
...
<link href="{{ data_get(end($config['icons']), 'src') }}" rel="apple-touch-icon">
